document.addEventListener("DOMContentLoaded", () => {
        ...
        if (message) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    chatInput.placeholder = window.innerWidth <= 480 ? "Ask me anything..." : "Ask me anything about my work...";
                }, 2000);
            }, 800);
        }
    });
    ...
    // Dynamic Placeholder for full responsiveness
    function handleResponsivePlaceholder() {
        if(chatInput) {
            chatInput.placeholder = window.innerWidth <= 480 ? "Ask me anything..." : "Ask me anything about my work...";
        }
    }
    ...
    // Listen for resize
    window.addEventListener('resize', handleResponsivePlaceholder);
});
